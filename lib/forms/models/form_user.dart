...
import 'package:shared_pref/forms/ui/home/ui/customer_page.dart';
import 'package:shared_pref/forms/ui/home/ui/mershant_page.dart';
...
class FormUser {
  ...
  factory FormUser.map(Map map){
    if(map['isMershant']){
      return FormUser.mershant(email: map['email'], password:map['password'], shopName:map['shopName'], shopAddress: map['shopAddress'], bio: map['bio'], category: map['category']);
    }else{
